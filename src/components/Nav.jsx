    ...
    <>
      ...
      <header className={`nav${scrolled ? ' nav-scrolled' : ''}`}>
        <div className="nav-inner">
          <Link to="/" className={`nav-compact-logo${scrolled ? ' nav-compact-logo-visible' : ''}`}>
            <TLTLogo size={38} color="white" />
          </Link>
          <div className={`nav-logo-wrap${scrolled ? ' nav-logo-wrap-hidden' : ''}`} ref={menuRef}>
