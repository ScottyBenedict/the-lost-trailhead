...
// TikTok and Facebook are placeholders until those accounts exist: no href
// yet, so they don't go anywhere. Add the profile URL to turn one on.
const SOCIALS = [
  { name: 'Instagram', icon: 'instagram', href: 'https://www.instagram.com/thelosttrailhead/' },
