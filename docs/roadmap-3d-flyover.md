...
## ✅ STATUS (updated 2026-09-25): Live on every hike; trailing camera on 21 of 33 hikes
...
- **Trailing ("drone behind the hiker") camera is per hike**, via
  `TRAILING_CAMERA_TEST` in `src/components/HikeMap.jsx`. Enabled on 21: Cascade Pass
  ...
  Winter, Lake Valhalla, Mt. Baldy, Annette Lake, Lake 22, Mailbox Peak — Old Trail. Remaining hikes are listed in the handoff.
